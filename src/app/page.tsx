    ...
    <main className="pm-sky relative isolate min-h-screen overflow-hidden">
      ...
      <div className="mx-auto flex min-h-screen max-w-5xl flex-col justify-center px-6 py-20">
            ...
            return (
              <div key={p.no} className="pm-panel relative flex flex-col gap-3 p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-heading text-sm font-bold text-muted-foreground/60">
                    Phase {p.no}
                  </span>
                </div>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-4">
          <Link
            href="/studio"
            className="group inline-flex items-center gap-2 rounded-full bg-primary px-7 py-3.5 font-semibold text-primary-foreground shadow-lg shadow-primary/25 transition-all hover:opacity-90 active:translate-y-px"
          >
